...
# =====================================================================
# 👇 ================================================================ 👇
TARGET_YEARS = 2026  # ephemeris setting below look for "👇"
# ENGINE OPTIMIZATION
...
# =====================================================================
def update_progress(completed, total, item_name, is_success, error=None):
    ...
    if is_success:
        print(f"[{bar}] {percent_done:5.1f}% | ✅ Month {item_name} appended to CSV! ({completed}/{total})")
    else:
        print(f"[{bar}] {percent_done:5.1f}% | ❌ Error processing Month {item_name}: {error} ({completed}/{total})")
...
if __name__ == '__main__':
    ...
    csv_filename = f"Regulus_RedStar_September_Visuals_{timestamp}.csv"
    headers = [
